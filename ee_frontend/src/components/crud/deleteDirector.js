...
export default function DeleteDirector() {
    ...
    return (
        <>
            {contextHolder}
            <Title style={{color: "#000000", textAlign: 'center'}}> Delete Director </Title>
            ...
            <div style={{
                ...
                <Search
                    placeholder="search for directors using last name"
                    onSearch={onSearch}
                    style={{
                        width: 500
                    }}
            ...
            {director.length !== 0 && (
                <>
                    <Space>
                        ...
                        <Col span={4} key={director.id}>
                            <Card bordered={false} title={`${director.firstName} ${director.lastName}`} style={{width: 300}}
                                  cover={<img src={director.avatarURL} alt={`${director.firstName} ${director.lastName}`}/>}>
                            </Card>
                        </Col>
                        <Flex vertical align="flex-end" justify="space-between" style={{padding: 32}}>
                            <Title level={3} type="danger">Are you sure you want to delete this director?</Title>
                            <Button danger onClick={() => deleteDirector(director.id)}>Delete</Button>
                        </Flex>
                    </Space>
                </>
            )}
